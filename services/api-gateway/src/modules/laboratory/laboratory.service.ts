...
export class LaboratoryService {
  ...
  async getLaboratory(authHeader: string, lab_id: string) {
    const response = await firstValueFrom(
      this.httpService.get(`${this.laboratoryServiceUrl}/laboratories/${lab_id}`, {
        headers: { Authorization: authHeader },
      }),
    );
    return response.data;
  ...
  async createLaboratory(authHeader: string, createDto: any) {
    const response = await firstValueFrom(
      this.httpService.post(`${this.laboratoryServiceUrl}/laboratories`, createDto, {
        headers: { Authorization: authHeader },
      }),
    );
    return response.data;
  ...
  async updateLaboratory(authHeader: string, lab_id: string, updateDto: any) {
    const response = await firstValueFrom(
      this.httpService.patch(`${this.laboratoryServiceUrl}/laboratories/${lab_id}`, updateDto, {
        headers: { Authorization: authHeader },
      }),
    );
    return response.data;
  ...
  async deleteLaboratory(authHeader: string, lab_id: string) {
    const response = await firstValueFrom(
      this.httpService.delete(`${this.laboratoryServiceUrl}/laboratories/${lab_id}`, {
        headers: { Authorization: authHeader },
      }),
    );
    return response.data;
